...
Frontend web construido con **Blazor Server (.NET 10 / C#)** que consume una API REST genérica en C# (`ApiGenericaCsharp`) para gestionar las tablas de una base de datos de facturación.
...
| **Blazor Server** | .NET 10 | Framework web (componentes interactivos con SignalR) |
