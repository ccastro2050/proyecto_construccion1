...
| Framework | Blazor Server | .NET 10.0 | Renderiza en servidor, conexión SignalR al navegador |
| Templates | Razor Components | (incluido) | HTML con `@` para lógica C# |
| CSS | Bootstrap 5 | 5.3 CDN | Sin npm ni build tools, responsive |
| API backend | ApiGenericaCsharp | .NET 10.0 | API genérica, funciona con cualquier BD |
...
└─────────────┬───────────────┘
              ...
              v
┌─────────────────────────────┐
│   CAPA DE NEGOCIO (API)     │   ApiGenericaCsharp (.NET 10.0)
