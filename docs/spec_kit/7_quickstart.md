...
1. **http://localhost:8010** → las dos APIs con badge verde "en línea"
...
5. **http://localhost:8011/swagger** y **http://localhost:8012/docs** abren.
6. **http://localhost:8091** (phpMyAdmin) entra directo y muestra
...
| localhost:8010 no abre | `docker compose ps` + `docker compose logs front` |
| Puerto ocupado (8010/8091/…) | Cerrar el otro programa o cambiar el mapeo en compose |
