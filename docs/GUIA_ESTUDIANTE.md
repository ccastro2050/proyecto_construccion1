...
|---|---|
| [Docker Desktop](https://www.docker.com/products/docker-desktop/) | Ejecuta las bases de datos y el entorno de Python en contenedores (no instala nada más en su PC) |
| [Visual Studio Code](https://code.visualstudio.com/) | Editor donde va a programar y administrar las bases de datos |
| [Git](https://git-scm.com/) | Descarga (clona) el proyecto desde GitHub |
